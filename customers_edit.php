      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link" href="customers_view.php?ref=<?php echo $customers_ref;?>" role="tab">View</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-link-active" href="customers_edit.php?ref=<?php echo $customers_ref;?>" role="tab">Edit</a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="col-md-12">
            ...
            <form action="process/customers_process.php" method="post" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border" name="customers_moodle_ref" id="customers_moodle_ref" placeholder="Moodle Ref" autocomplete="off" value="<?php echo $customers_moodle_ref;?>">
                      </div>
...
<script type="text/javascript">
  $('#customers_dob').inputmask('yyyy/mm/dd', { 'placeholder': 'yyyy/mm/dd/yyyy' })
