...
include_once('fetch/custcom_fetch_table.php');
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label for="filterField1">Communication Code</label>
                              <input type="text" name="custcom_name" class="form-control form_search_input_text" id="custcom_name" placeholder="Enter Communication Code" value="<?php echo $_REQUEST['custcom_name']; ?>">
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link nav-link-active" href="custcom.php?cus=<?php echo $CUS;?>" role="tab">Communication</a>
                  </li>
                </ul>
              </div>
              <!-- /.card -->
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-primary" href="custcom_edit.php?cus=<?php echo $CUS; ?>"><i class="nav-icon fas fa-plus"></i> New</a> 
              ...
              <div class="card-body p-0">
                <table class="table table-striped">
                  ...
                  ?>
                      ...
                      <tr>
                        <td><?php echo $DATA_SINGLE->custcom_id; ?></td>
                        <td><?php echo $DATA_SINGLE->custcom_name ; ?></td>
                        <td><?php echo $DATA_SINGLE->communication_type; ?></td>
                        <td><?php echo $DATA_SINGLE->communication_reason; ?></td>
                        <td>
                          <?php 
                            $status = $DATA_SINGLE->custcom_status_id; 
                            $class = "bg-info";
                            $label = "Active";
                        ...
                        <td>
                          <div class="btn-group">
                            <a type="button" class="btn btn-sm btn-success" href="custcom_view.php?cus=<?php echo $CUS; ?>&ref=<?php echo $DATA_SINGLE->custcom_ref; ?>"><i class="nav-icon fas fa-eye"></i></a> 
                            <a type="button" class="btn btn-sm btn-warning" href="custcom_edit.php?cus=<?php echo $CUS; ?>&ref=<?php echo $DATA_SINGLE->custcom_ref; ?>"><i class="nav-icon fas fa-edit"></i></a> 
                            <!-- <a type="button" class="btn btn-sm btn-danger" href="custcom_delete.php?ref=<?php echo $DATA_SINGLE->custcom_ref; ?>"><i class="nav-icon fas fa-trash"></i></a> -->
                          </div>
                        </td>
                      </tr>
