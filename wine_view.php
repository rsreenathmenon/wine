            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link nav-link-active" href="wine_view.php?ref=<?php echo $wine_ref;?>" role="tab">View</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border" name="wine_ref" id="wine_ref" placeholder="Reference" readonly="readonly" value="<?php echo $wine_ref;?>">
                      </div>
                      <div class="form-group">
