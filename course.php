...
include_once('fetch/course_fetch_table.php');
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="course_name" class="form-control form_search_input_text" id="course_name" placeholder="Enter Name" value="<?php echo $_REQUEST['course_name']; ?>">
                            </div>

                            <div class="form-group">
                              <label for="course_coursecategory_ref">Category</label>
                              <select class="custom-select form-control-border form_search_input_select" name="course_coursecategory_ref" id="course_coursecategory_ref">
                                ...
                                <?php
                                  ...
                                  for($ij=0; $ij<count($data_table_coursecategory); $ij++)
                                  {
                                    ...
                                    if($coursecategory_ref==$_REQUEST['course_coursecategory_ref'])
                                    {
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-primary" href="course_edit.php"><i class="nav-icon fas fa-plus"></i> New</a> 
              ...
              <div class="card-body p-0">
                <table class="table table-striped">
                  ...
                  ?>
                      ...
                      <tr>
                        <td><?php echo $DATA_SINGLE->course_id; ?></td>
                        <td><?php echo $DATA_SINGLE->course_name ; ?></td>
                        <td><?php echo $DATA_SINGLE->coursecategory_name ; ?></td>
                        <td><?php echo $DATA_SINGLE->course_code ; ?></td>
                        <td>
                          <?php 
                            $status = $DATA_SINGLE->course_status_id; 
                            $class = "bg-info";
                            $label = "Active";
                        ...
                        <td>
                          <div class="btn-group">
                            <a type="button" class="btn btn-sm btn-success" href="course_view.php?ref=<?php echo $DATA_SINGLE->course_ref; ?>"><i class="nav-icon fas fa-eye"></i></a> 
                            <a type="button" class="btn btn-sm btn-warning" href="course_edit.php?ref=<?php echo $DATA_SINGLE->course_ref; ?>"><i class="nav-icon fas fa-edit"></i></a> 
                            <!-- <a type="button" class="btn btn-sm btn-danger" href="course_delete.php?ref=<?php echo $DATA_SINGLE->course_ref; ?>"><i class="nav-icon fas fa-trash"></i></a> -->
                          </div>
                        </td>
                      </tr>
