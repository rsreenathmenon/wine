...
include_once('fetch/list_generator_query_generator_test.php');
	            ...
	            <div class="col-12" id="accordion">
		                        ...
		                        <div class="row">
		                          <div class="col-sm-6">
		                            <div class="form-group">
		                              ...
		                              <select class="custom-select form-control-border" name="list_generator_name" id="list_generator_name">
				                          <option value="" <?php if($_POST['list_generator_name']==""){echo 'selected="selected"';}?> >-- SELECT --</option>
				                          <?php
				              							...
				              							for($ij=0; $ij<count($data_table_pack); $ij++)
				              							{
				              							  ...
				              							  if($pack_ref==$_POST['list_generator_name'])
				              							  {
	                ...
	                <div id="accordiancard_5" class="card card-warning card-outline">
	                    ...
	                    <div id="collapseexportdata" class="collapse" data-parent="#accordion">
		                      ...
		                      <div class="card-footer">
		                      	<?php 
		                      	if(trim($response_data->list_generator_ref)!="")
		                      	{
		                      	?>
			                        <a target="_blank" href="process/list_generator_export_excel.php?list_generator_ref=<?php echo $response_data->list_generator_ref;?>" class="btn btn-primary filter-btn filter-btn-export" value="excel">Excel</a>
			                        <label> &nbsp;  &nbsp;  &nbsp; </label>
			                        <a target="_blank" href="process/list_generator_export_phone.php?list_generator_ref=<?php echo $response_data->list_generator_ref;?>" class="btn btn-primary filter-btn filter-btn-export" value="phoneList">Phone List</a>
			                        <label> &nbsp;  &nbsp;  &nbsp; </label>
			                        <a target="_blank" href="process/list_generator_export_postal.php?list_generator_ref=<?php echo $response_data->list_generator_ref;?>" class="btn btn-primary filter-btn filter-btn-export" value="australiaPostLabel">Australia Post Label</a>
		                        <?php
			                    }
			                    ?>
		                      </div>
...
<script type="text/javascript">
  custom_js_nav_bar_selection("list_generator");
