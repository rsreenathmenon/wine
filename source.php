...
include_once('fetch/source_fetch_table.php');
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="source_name" class="form-control form_search_input_text" id="source_name" placeholder="Enter Name" value="<?php echo $_REQUEST['source_name']; ?>">
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-primary" href="source_edit.php"><i class="nav-icon fas fa-plus"></i> New</a> 
              ...
              <div class="card-body p-0">
                <table class="table table-striped">
                  ...
                  ?>
                      ...
                      <tr>
                        <td><?php echo $DATA_SINGLE->source_id; ?></td>
                        <td><?php echo $DATA_SINGLE->source_name ; ?></td>
                        <td>
                          <?php 
                            $status = $DATA_SINGLE->source_status_id; 
                            $class = "bg-info";
                            $label = "Active";
                        ...
                        <td>
                          <div class="btn-group">
                            <a type="button" class="btn btn-sm btn-success" href="source_view.php?ref=<?php echo $DATA_SINGLE->source_ref; ?>"><i class="nav-icon fas fa-eye"></i></a> 
                            <a type="button" class="btn btn-sm btn-warning" href="source_edit.php?ref=<?php echo $DATA_SINGLE->source_ref; ?>"><i class="nav-icon fas fa-edit"></i></a> 
                            <!-- <a type="button" class="btn btn-sm btn-danger" href="source_delete.php?ref=<?php echo $DATA_SINGLE->source_ref; ?>"><i class="nav-icon fas fa-trash"></i></a> -->
                          </div>
                        </td>
                      </tr>
