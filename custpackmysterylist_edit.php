...
include_once('fetch/custpackmysterylist_fetch_detail.php');
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="custpackmysterylist.php">Customer Pack Mystery List</a></li>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="process/custpackmysterylist_process.php" method="post" >
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="customers_fullname"><h4><?php echo $customers_fullname;?></h4></label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
