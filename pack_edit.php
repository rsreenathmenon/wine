                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border" name="pack_ref" id="pack_ref" placeholder="Reference" readonly="readonly" value="<?php if($_REQUEST['clone']!="true"){ echo $pack_ref; }?>">
                      </div>
...
<script type="text/javascript">
  ...
  custom_js_order_code_generator();
