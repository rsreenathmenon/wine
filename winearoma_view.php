                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border" name="winearoma_name" id="winearoma_name" placeholder="First Name" autocomplete="off" value="<?php echo $winearoma_name;?>">
                      </div>
                      <div class="form-group">
