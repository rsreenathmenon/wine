...
include_once('fetch/com_generator_query_generator.php');
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Communication List Generator</h1>
          </div><!-- /.col -->

          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo HTTP_SERVER; ?>">Home</a></li>
              <li class="breadcrumb-item active">Communication List Generator</li>
            </ol>
          </div><!-- /.col -->
	            ...
	            <div class="col-12" id="accordion">
		                        ...
		                        <div class="row">
		                          <div class="col-sm-6">
		                            <div class="form-group">
		                              <label for="filterField1">Select Communication Code</label>
		                              <select class="custom-select form-control-border" name="com_generator_name" id="com_generator_name">
				                          <option value="" <?php if($_POST['com_generator_name']==""){echo 'selected="selected"';}?> >-- SELECT --</option>
				                          <?php
				              							...
				              							for($ij=0; $ij<count($data_table_communication); $ij++)
				              							{
				              							  ...
				              							  if($communication_ref==$_POST['com_generator_name'])
				              							  {
				              							  	$option .= "selected='selected'";
				              							  }
				              							  $option .= ">";
				              							  $option .= $communication_code;
				              							  $option .= "</option>";
		                        ...
		                        <div class="row">
				                        ...
				                        <div class="card card-primary filter-sub-section collapsed-card">
				                          ...
				                          <div class="card-body">
											...
											<div class="row">
												...
												<div class="form-group col-lg-6">
													<label for="customers_source_ref">Contact Source</label>	
													<?php
					                                  ...
					                                  for($ij=0; $ij<count($data_table_source); $ij++)
					                                  {
					                                    ...
					                                    ?>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" value="<?php echo $source_ref; ?>" <?php if (in_array($source_ref, $_POST['customers_source_ref'])){  echo "checked='checked'";  } ?> name="customers_source_ref[]"><label class="form-check-label"><?php echo $source_name; ?></label>
															</div>
					                                    <?php
					                                  }
												...
												<div class="form-group col-lg-6">
													<label for="customers_regtype">Contact Stage</label>												
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Partial" <?php if (in_array("Partial", $_POST['customers_regtype'])){  echo "checked='checked'";  } ?> name="customers_regtype[]"><label class="form-check-label">Partial</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Full" <?php if (in_array("Full", $_POST['customers_regtype'])){  echo "checked='checked'";  } ?> name="customers_regtype[]"><label class="form-check-label">Full</label>
													</div>
												</div>
												...
												<div class="form-group col-lg-6">
													...
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Free" <?php if (in_array("Free", $_POST['customers_memlvl'])){  echo "checked='checked'";  } ?> name="customers_memlvl[]"><label class="form-check-label">Free</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Paid" <?php if (in_array("Paid", $_POST['customers_memlvl'])){  echo "checked='checked'";  } ?> name="customers_memlvl[]"><label class="form-check-label">Paid</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Expired" <?php if (in_array("Expired", $_POST['customers_memlvl'])){  echo "checked='checked'";  } ?> name="customers_memlvl[]"><label class="form-check-label">Expired</label>
													</div>
												</div>
												...
												<div class="form-group col-lg-6">
													...
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Bronze" <?php if (in_array("Bronze", $_POST['customers_loyaltylvl'])){  echo "checked='checked'";  } ?> name="customers_loyaltylvl[]"><label class="form-check-label">Bronze</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Silver" <?php if (in_array("Silver", $_POST['customers_loyaltylvl'])){  echo "checked='checked'";  } ?> name="customers_loyaltylvl[]"><label class="form-check-label">Silver</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Gold" <?php if (in_array("Gold", $_POST['customers_loyaltylvl'])){  echo "checked='checked'";  } ?> name="customers_loyaltylvl[]"><label class="form-check-label">Gold</label>
													</div>
												</div>
												...
												<div class="form-group col-lg-6">
													...
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Standard" <?php if (in_array("Standard", $_POST['customers_classification'])){  echo "checked='checked'";  } ?> name="customers_classification[]"><label class="form-check-label">Standard</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="VIP" <?php if (in_array("VIP", $_POST['customers_classification'])){  echo "checked='checked'";  } ?> name="customers_classification[]"><label class="form-check-label">VIP</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Media" <?php if (in_array("Media", $_POST['customers_classification'])){  echo "checked='checked'";  } ?> name="customers_classification[]"><label class="form-check-label">Media</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="Other" <?php if (in_array("Other", $_POST['customers_classification'])){  echo "checked='checked'";  } ?> name="customers_classification[]"><label class="form-check-label">Other</label>
													</div>
												</div>
		                        	...
		                        	<div class="col-sm-6">
				                        <div class="card card-primary filter-sub-section collapsed-card">
				                          ...
				                          <div class="card-header">
				                            <h3 class="card-title">Coporate Details</h3>
																		...
																		<div class="row">
																			...
																			<div class="form-group col-lg-6">
																				...
																				<?php
												                                  ...
												                                  $data_table_customers_product = $response_data->customers_product;
												                                  for($ij=0; $ij<count($data_table_customers_product); $ij++)
												                                  {
												                                    $data_row_customers_product = (array) $data_table_customers_product[$ij];
												                                    extract($data_row_customers_product);

												                                    ?>
																						<div class="form-check">
																							<input class="form-check-input" type="checkbox" value="<?php echo $customers_product; ?>" <?php if (in_array($customers_product, $_POST['customers_product'])){  echo "checked='checked'";  } ?> name="customers_product[]"><label class="form-check-label"><?php echo $customers_product; ?></label>
																						</div>
												                                    <?php
												                                  }
																			...
																			<div class="form-group col-lg-6">
																				...
																				<?php
												                                  ...
												                                  $data_table_customers_company = $response_data->customers_company;
												                                  for($ij=0; $ij<count($data_table_customers_company); $ij++)
												                                  {
												                                    $data_row_customers_company = (array) $data_table_customers_company[$ij];
												                                    extract($data_row_customers_company);

												                                    ?>
																						<div class="form-check">
																							<input class="form-check-input" type="checkbox" value="<?php echo $customers_company; ?>" <?php if (in_array($customers_company, $_POST['customers_company'])){  echo "checked='checked'";  } ?> name="customers_company[]"><label class="form-check-label"><?php echo $customers_company; ?></label>
																						</div>
												                                    <?php
												                                  }
																			...
																			<div class="form-group col-lg-6">
																				...
																				<?php
												                                  ...
												                                  $data_table_customers_cohort = $response_data->customers_cohort;
												                                  for($ij=0; $ij<count($data_table_customers_cohort); $ij++)
												                                  {
												                                    $data_row_customers_cohort = (array) $data_table_customers_cohort[$ij];
												                                    extract($data_row_customers_cohort);

												                                    ?>
																						<div class="form-check">
																							<input class="form-check-input" type="checkbox" value="<?php echo $customers_cohort; ?>" <?php if (in_array($customers_cohort, $_POST['customers_cohort'])){  echo "checked='checked'";  } ?> name="customers_cohort[]"><label class="form-check-label"><?php echo $customers_cohort; ?></label>
																						</div>
												                                    <?php
												                                  }
																			...
																			<div class="form-group col-lg-6">
																				...
																				<?php
												                                  ...
												                                  $data_table_customers_enrollment = $response_data->customers_enrollment;
												                                  for($ij=0; $ij<count($data_table_customers_enrollment); $ij++)
												                                  {
												                                    $data_row_customers_enrollment = (array) $data_table_customers_enrollment[$ij];
												                                    extract($data_row_customers_enrollment);

												                                    ?>
																						<div class="form-check">
																							<input class="form-check-input" type="checkbox" value="<?php echo $customers_enrollment; ?>" <?php if (in_array($customers_enrollment, $_POST['customers_enrollment'])){  echo "checked='checked'";  } ?> name="customers_enrollment[]"><label class="form-check-label"><?php echo $customers_enrollment; ?></label>
																						</div>
												                                    <?php
												                                  }
				                          ...
				                          <div class="card-body">
											...
											<div class="form-group">
												...
												<div class="form-group col-lg-6">
													...
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="1" <?php if (in_array("1", $_POST['customers_status_id'])){  echo "checked='checked'";  } ?> name="customers_status_id[]"><label class="form-check-label">Active</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="2" <?php if (in_array("2", $_POST['customers_status_id'])){  echo "checked='checked'";  } ?> name="customers_status_id[]"><label class="form-check-label">Inactive</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="checkbox" value="3" <?php if (in_array("3", $_POST['customers_status_id'])){  echo "checked='checked'";  } ?> name="customers_status_id[]"><label class="form-check-label">Deleted</label>
													</div>
												</div>
		                        	...
		                        	<div class="col-sm-6">
				                        <div class="card card-primary filter-sub-section collapsed-card">
				                          ...
				                          <div class="card-body">
											...
											<div class="row">
												<div class="form-group col-lg-6">
													<label for="custcom_already_sent_ignore">Ignore clients who have already received this communication?</label>
													<div class="form-check">
														<input class="form-check-input" type="radio" value="1" <?php if($_POST['custcom_already_sent_ignore']=="1"){  echo "checked='checked'";  } ?> name="custcom_already_sent_ignore"><label class="form-check-label">Yes</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="radio" value="2" <?php if($_POST['custcom_already_sent_ignore']=="2"){  echo "checked='checked'";  } ?> name="custcom_already_sent_ignore"><label class="form-check-label">No</label>
													</div>
												</div>


												<div class="form-group col-lg-6">
													<label for="customers_optout">Ignore clients who have opt-out?</label>
													<div class="form-check">
														<input class="form-check-input" type="radio" value="No" checked='checked' name="customers_optout"><label class="form-check-label">Yes</label>
													</div>
													<div class="form-check">
														<input class="form-check-input" type="radio" value="Yes" <?php if($_POST['customers_optout']=="Yes"){  echo "checked='checked'";  } ?> name="customers_optout"><label class="form-check-label">No</label>
													</div>
												</div>
	                ...
	                <div id="accordiancard_5" class="card card-warning card-outline">
	                    ...
	                    <div id="collapseexportdata" class="collapse" data-parent="#accordion">
		                      ...
		                      <div class="card-footer">
		                      	<?php 
		                      	if(trim($response_data->com_generator_ref)!="")
		                      	{
		                      	?>
			                        <a target="_blank" href="process/com_generator_export_excel.php?com_generator_ref=<?php echo $response_data->com_generator_ref;?>" class="btn btn-primary filter-btn filter-btn-export" value="excel">Excel</a>
			                        <label> &nbsp;  &nbsp;  &nbsp; </label>
			                        <a target="_blank" href="process/com_generator_export_phone.php?com_generator_ref=<?php echo $response_data->com_generator_ref;?>" class="btn btn-primary filter-btn filter-btn-export" value="phoneList">Phone List</a>
			                        <label> &nbsp;  &nbsp;  &nbsp; </label>
			                        <a target="_blank" href="process/com_generator_export_postal.php?com_generator_ref=<?php echo $response_data->com_generator_ref;?>" class="btn btn-primary filter-btn filter-btn-export" value="australiaPostLabel">Australia Post Label</a>
		                        <?php
			                    }
			                    ?>
		                      </div>
...
<script type="text/javascript">
  custom_js_nav_bar_selection("com_generator");
  ...
  custom_js_navigation_com_generator();
  custom_js_reset_filter_com_generator();
  custom_js_open_all_filter_com_generator();
