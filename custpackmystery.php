...
include_once('fetch/custpackmystery_fetch_table.php');
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="custpackfeedback.php?cus=<?php echo $CUS;?>" role="tab">Feedback</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-link-active" href="custpackmystery.php?cus=<?php echo $CUS;?>" role="tab">Mystery</a>
                  </li>
                  <li class="nav-item">
                ...
                <table class="table table-striped">
                  ...
                  ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a type="button" class="btn btn-sm btn-success" href="custpackmystery_view.php?cus=<?php echo $CUS; ?>&ref=<?php echo $DATA_SINGLE->custpackmystery_ref; ?>"><i class="nav-icon fas fa-eye"></i></a> 
                            <a type="button" class="btn btn-sm btn-warning" href="custpackmystery_edit.php?cus=<?php echo $CUS; ?>&ref=<?php echo $DATA_SINGLE->custpackmystery_ref; ?>"><i class="nav-icon fas fa-edit"></i></a> 
