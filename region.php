...
include_once('fetch/region_fetch_table.php');
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="region_name" class="form-control form_search_input_text" id="region_name" placeholder="Enter Name" value="<?php echo $_REQUEST['region_name']; ?>">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              ...
                              <select class="custom-select form-control-border form_search_input_select" name="region_country_ref" id="region_country_ref" onchange="js_region_edit_country_change()">
                                ...
                                <?php
                                  ...
                                  for($ij=0; $ij<count($data_table_country); $ij++)
                                  {
                                    ...
                                    if($country_ref==$_REQUEST['region_country_ref'])
                                    {
                            ...
                            <div class="form-group">
                              ...
                              <select class="custom-select form-control-border form_search_input_select" name="region_states_ref" id="region_states_ref">
                                <option value="" selected='selected' >-- SELECT --</option>
                              </select>
                            </div>
                          </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-primary" href="region_edit.php"><i class="nav-icon fas fa-plus"></i> New</a> 
              ...
              <div class="card-body p-0">
                <table class="table table-striped">
                  ...
                  ?>
                      ...
                      <tr>
                        <td><?php echo $DATA_SINGLE->region_id; ?></td>
                        <td><?php echo $DATA_SINGLE->region_name ; ?></td>
                        <td><?php echo $DATA_SINGLE->country_name ; ?></td>
                        <td><?php echo $DATA_SINGLE->states_name ; ?></td>
                        <td>
                          <?php 
                            $status = $DATA_SINGLE->region_status_id; 
                            $class = "bg-info";
                            $label = "Active";
                        ...
                        <td>
                          <div class="btn-group">
                            <a type="button" class="btn btn-sm btn-success" href="region_view.php?ref=<?php echo $DATA_SINGLE->region_ref; ?>"><i class="nav-icon fas fa-eye"></i></a> 
                            <a type="button" class="btn btn-sm btn-warning" href="region_edit.php?ref=<?php echo $DATA_SINGLE->region_ref; ?>"><i class="nav-icon fas fa-edit"></i></a> 
                            <!-- <a type="button" class="btn btn-sm btn-danger" href="region_delete.php?ref=<?php echo $DATA_SINGLE->region_ref; ?>"><i class="nav-icon fas fa-trash"></i></a> -->
                          </div>
                        </td>
                      </tr>
...
<script type="text/javascript">
  ...
  function js_region_edit_country_change()
  {
    ...
    OptionToSelect = "<?php echo $_REQUEST['region_states_ref']; ?>";
