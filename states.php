...
include_once('fetch/states_fetch_table.php');
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="states_name" class="form-control form_search_input_text" id="states_name" placeholder="Enter Name" value="<?php echo $_REQUEST['states_name']; ?>">
                            </div>

                            <div class="form-group">
                              <label for="states_country_ref">Country</label>
                              <select class="custom-select form-control-border form_search_input_select" name="states_country_ref" id="states_country_ref">
                                ...
                                <?php
                                  ...
                                  for($ij=0; $ij<count($data_table_country); $ij++)
                                  {
                                    ...
                                    if($country_ref==$_REQUEST['states_country_ref'])
                                    {
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-primary" href="states_edit.php"><i class="nav-icon fas fa-plus"></i> New</a> 
                ...
                <table class="table table-striped">
                  ...
                  ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a type="button" class="btn btn-sm btn-success" href="states_view.php?ref=<?php echo $DATA_SINGLE->states_ref; ?>"><i class="nav-icon fas fa-eye"></i></a> 
                            <a type="button" class="btn btn-sm btn-warning" href="states_edit.php?ref=<?php echo $DATA_SINGLE->states_ref; ?>"><i class="nav-icon fas fa-edit"></i></a> 
                            <!-- <a type="button" class="btn btn-sm btn-danger" href="states_delete.php?ref=<?php echo $DATA_SINGLE->states_ref; ?>"><i class="nav-icon fas fa-trash"></i></a> -->
                          </div>
                        </td>
                      </tr>
