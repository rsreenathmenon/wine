...
include_once('fetch/custcourse_fetch_table.php');
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Customer Course</h1>
          </div><!-- /.col -->

          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="customers.php">Customers List</a></li>
              <li class="breadcrumb-item active">Customer Course</li>
            </ol>
          </div><!-- /.col -->
    ...
    <section class="content">
        <div class="row">
            <div class="col-12 hide" id="accordion">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="custcourse_name" class="form-control form_search_input_text" id="custcourse_name" placeholder="Enter Pack Code" value="<?php echo $_REQUEST['custcourse_name']; ?>">
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link nav-link-active" href="custcourse.php?cus=<?php echo $CUS;?>" role="tab">Course</a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-primary hide" href="custcourse_edit.php?cus=<?php echo $CUS; ?>"><i class="nav-icon fas fa-plus"></i> New</a> 
              ...
              <div class="card-body p-0">
                <table class="table table-striped">
                  ...
                  ?>
                      ...
                      <tr>
                        <td><?php echo $DATA_SINGLE->custcourse_id; ?></td>
                        <td><?php echo $DATA_SINGLE->course_name ; ?></td>
                        <td>
                          <?php 
                            $status = $DATA_SINGLE->custcourse_status_id; 
                            $class = "bg-info";
                            $label = "Active";
                        ...
                        <td>
                          <div class="btn-group">
                            <!-- <a type="button" class="btn btn-sm btn-success" href="custcourse_view.php?cus=<?php echo $CUS; ?>&ref=<?php echo $DATA_SINGLE->custcourse_ref; ?>"><i class="nav-icon fas fa-eye"></i></a>  -->
                            <!-- <a type="button" class="btn btn-sm btn-warning" href="custcourse_edit.php?cus=<?php echo $CUS; ?>&ref=<?php echo $DATA_SINGLE->custcourse_ref; ?>"><i class="nav-icon fas fa-edit"></i></a>  -->
                            <!-- <a type="button" class="btn btn-sm btn-danger" href="custcourse_delete.php?ref=<?php echo $DATA_SINGLE->custcourse_ref; ?>"><i class="nav-icon fas fa-trash"></i></a> -->
                          </div>
                        </td>
                      </tr>
