			                	...
			                	<div class="row">
				                	<div class="col-sm-6">
					                  <div class="form-group">
					                    ...
					                    <input type="text" name="users_firstname" class="form-control form_search_input_text" id="users_firstname" placeholder="Enter First Name" value="<?php echo $_REQUEST['users_firstname']; ?>">
					                  </div>
					                </div>
				                	<div class="col-sm-6">
					                  <div class="form-group">
					                    <label for="filterField2">Last Name</label>
					                    <input type="text" name="users_lastname" class="form-control form_search_input_text" id="users_lastname" placeholder="Enter First Name" value="<?php echo $_REQUEST['users_lastname']; ?>">
					                  </div>
					                </div>
					            </div>
			                </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
              ...
              <div class="card-header">
                ...
                <a class="btn btn-primary" href="users_edit.php"><i class="nav-icon fas fa-plus"></i> New</a> 
